...
2) Integrated HVDC and MTDC Configurations
...
•	Converter data is included in DC_Converters.csv, including interconnected AC and DC buses, converter ratings, reactive power control mode, droop parameters, current limit, and current    limiting strategies.
